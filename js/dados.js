// =====================================================================
//  DATOS DEL MENÚ
//  - "disponible": true/false  -> producto disponible o agotado
//  - "pesaje":     { unidades: [...], defecto: 'lb', precioPor: 'lb' }
//      Solo se aplica a las categorías "Harinas" (steaks) y "Cárnicos"
//      (churrasco). Permite al cliente elegir entre libras y kilogramos.
//      El precio en kilogramos se calcula automáticamente a partir del
//      precio por libra (1 kg = 2.2046226 lb).
// =====================================================================
var MENU = {
    "churrasco": [
        {
            ...
            "price": 200,
            "disponible": true,
            "pesaje": { "unidades": ["lb", "kg"], "defecto": "lb", "precioPor": "lb" }
        },
        {
